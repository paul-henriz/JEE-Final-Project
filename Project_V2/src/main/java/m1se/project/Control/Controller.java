    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (request.getParameter("action")) {
            ...
            case FRM_ACTION_DETAIL:
                if (currentUser != null) {
                    selectedEmployee = eSB.getEmployeeByID(request.getParameter(FRM_ID_FIELD));
            ...
            case FRM_ACTION_SAVE:
                if (currentUser != null) {
                    if (currentUser.getIsAdmin()) {
                        ...
                        selectedEmployee.setTelMob(request.getParameter(FRM_TELMOB_FIELD));
                        selectedEmployee.setTelPro(request.getParameter(FRM_TELPRO_FIELD));
                        selectedEmployee.setAdress(request.getParameter(FRM_ADDRESS_FIELD));
